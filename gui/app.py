...
class ChatbotApp:
    def __init__(self, root):
        ...
        self.add_bot_message("¡Hola! Soy el asistente virtual de la UNEG. "
                             "Pregúntame sobre carreras, inscripciones, requisitos u horarios. "
    ...
    def _build_info_panel(self, paned):
        ...
        bellman_frame = ttk.LabelFrame(info_frame, text="Ecuación de Bellman", padding=10)
        ...
        q_frame = ttk.LabelFrame(info_frame, text="Tabla Q (Estados × Acciones)", padding=10)
        ...
        hist_frame = ttk.LabelFrame(info_frame, text="Última Actualización", padding=10)
    ...
    def _process_and_respond(self, msg):
        ...
        self.status_label.config(
            text=f"Intención: {state_key} | Acción: A{action_idx} (original: {origin})"
        )
        self._update_stats()
        self._update_bellman_display()
    ...
    def _give_feedback(self, state_key, action_idx, reward, like_btn, dislike_btn):
        ...
        self.status_label.config(
            text=f"Recibido: {reward_text} | Estado: {state_key} | Acción: A{action_idx} (respuesta de: {origin})"
        )
    ...
    def _update_bellman_display(self):
        ...
        self.bellman_text.insert("end", f"Precisión: {stats['acierto']}%\n")
